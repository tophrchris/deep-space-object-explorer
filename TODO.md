...
## Phase 1: Location + Sky Semantics
...
## Phase 3: External Data & Conditions
...
## Phase 4: UI/UX Polish (Deferred by request)
...
- [ ] list management as a first class app experience- show objects in list with a denser comparison/table view
